...
//************************************************************************
/*
	$Id: location.php,v 1.8 2005/10/01 23:44:25 ralfoide Exp $
...
$dir_abs_install		= "/usr/local/Rig/rig/";
...
// The directory string must end with / (un*x) or \\ (windows)
$dir_abs_src			= $dir_abs_install . "src" . S;
$dir_abs_admin_src		= $dir_abs_install . "admin" . S;

$dir_abs_templates		= $dir_abs_install . "templates" . S;

// global settings
// Note: $dir_abs_globset semantic has changed! Path is *absolute* instead of relative to $dir_abs_install
// The directory string must end with / (un*x) or \\ (windows)
$dir_abs_globset		= $dir_abs_install . "settings" . S;
